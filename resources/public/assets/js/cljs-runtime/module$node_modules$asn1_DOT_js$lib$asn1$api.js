shadow$provide.module$node_modules$asn1_DOT_js$lib$asn1$api = function(global, require, module, exports) {
  ...
  var asn1 = require("module$node_modules$asn1_DOT_js$lib$asn1"), inherits = require("module$node_modules$inherits$inherits_browser");
  exports.define = function(name, body) {
    return new Entity(name, body);
  };
  Entity.prototype._createNamed = function(base) {
    try {
      var named = require("module$node_modules$vm_browserify$index").runInThisContext("(function " + this.name + "(entity) {\n  this._initNamed(entity);\n})");
    } catch (e) {
