shadow$provide.module$node_modules$react$cjs$react_jsx_runtime_development = function(global, require, module, exports) {
  (function() {
    ...
    function jsxWithValidation(type, props, key, isStaticChildren, source, self) {
      ...
      void 0 !== key && (checkKeyStringCoercion(key), sourceInfo = "" + key);
      b: {
        if (hasOwnProperty.call(props, "key") && (key = Object.getOwnPropertyDescriptor(props, "key").get) && key.isReactWarning) {
          key = !1;
          break b;
        }
        key = void 0 !== props.key;
      }
      key && (checkKeyStringCoercion(props.key), sourceInfo = "" + props.key);
      b: {
        if (hasOwnProperty.call(props, "ref") && (key = Object.getOwnPropertyDescriptor(props, "ref").get) && key.isReactWarning) {
          key = !1;
          break b;
        }
        key = void 0 !== props.ref;
      }
      key && (ref = props.ref, "string" === typeof props.ref && ReactCurrentOwner.current && self && ReactCurrentOwner.current.stateNode !== self && (key = getComponentNameFromType(ReactCurrentOwner.current.type), didWarnAboutStringRefs[key] || (error('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', 
      getComponentNameFromType(ReactCurrentOwner.current.type), props.ref), didWarnAboutStringRefs[key] = !0)));
      ...
      if (type && type.defaultProps) {
        for (propName in key = type.defaultProps, key) {
          void 0 === info[propName] && (info[propName] = key[propName]);
        }
      }
      if (sourceInfo || ref) {
      ...
      if (validType && (props = props.children, void 0 !== props)) {
        if (isStaticChildren) {
      ...
      if (type === REACT_FRAGMENT_TYPE) {
        for (var keys = Object.keys(propName.props), i = 0; i < keys.length; i++) {
          if (type = keys[i], "children" !== type && "key" !== type) {
        ...
        null !== propName.ref && (setCurrentlyValidatingElement$1(propName), error("Invalid attribute `ref` supplied to `React.Fragment`."), setCurrentlyValidatingElement$1(null));
      } else {
        a: {
          if (type = propName.type, null !== type && void 0 !== type && "string" !== typeof type) {
            if ("function" === typeof type) {
              props = type.propTypes;
            } else if ("object" !== typeof type || type.$$typeof !== REACT_FORWARD_REF_TYPE && type.$$typeof !== REACT_MEMO_TYPE) {
              break a;
            } else {
              props = type.propTypes;
            }
            if (props) {
              for (keys in isStaticChildren = getComponentNameFromType(type), source = propName.props, self = Function.call.bind(hasOwnProperty), props) {
                if (self(props, keys)) {
                  validType = void 0;
                  try {
                    if ("function" !== typeof props[keys]) {
              ...
              void 0 === type.PropTypes || propTypesMisspellWarningShown || (propTypesMisspellWarningShown = !0, keys = getComponentNameFromType(type), error("Component %s declared `PropTypes` instead of `propTypes`. Did you misspell the property assignment?", keys || "Unknown"));
            }
