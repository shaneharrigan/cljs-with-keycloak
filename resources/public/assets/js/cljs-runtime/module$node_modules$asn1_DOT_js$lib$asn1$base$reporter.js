shadow$provide.module$node_modules$asn1_DOT_js$lib$asn1$base$reporter = function(global, require, module, exports) {
  ...
  Reporter.prototype.error = function(msg) {
    var state = this._reporterState, inherited = msg instanceof ReporterError;
    msg = inherited ? msg : new ReporterError(state.path.map(function(elem) {
      return "[" + JSON.stringify(elem) + "]";
    }).join(""), msg.message || msg, msg.stack);
    if (!state.options.partial) {
      throw msg;
    }
    inherited || state.errors.push(msg);
    return msg;
  };
