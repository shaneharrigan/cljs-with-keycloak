...
var G__43397 = cljs.core.next(xs);
var G__43398 = cljs.core.next(ys);
xs = G__43397;
ys = G__43398;
continue;
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__43349 = val;
var G__43350 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__43349,G__43350) : f.call(null,G__43349,G__43350));
})();
...
while(true){
if((n < cnt)){
var nval = (function (){var G__43351 = val__$1;
var G__43352 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__43351,G__43352) : f.call(null,G__43351,G__43352));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__43353 = val__$1;
var G__43354 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__43353,G__43354) : f.call(null,G__43353,G__43354));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
var tcoll__$1 = tcoll;
while(true){
var temp__5809__auto__ = cljs.core.first(es);
if(cljs.core.truth_(temp__5809__auto__)){
var e = temp__5809__auto__;
var G__43411 = cljs.core.next(es);
var G__43412 = cljs.core._assoc_BANG_(tcoll__$1,cljs.core.key(e),cljs.core.val(e));
es = G__43411;
tcoll__$1 = G__43412;
continue;
} else {
...
var G__43413 = cljs.core._assoc(ret,cljs.core._nth(e,(0)),cljs.core._nth(e,(1)));
var G__43414 = cljs.core.next(es);
ret = G__43413;
es = G__43414;
continue;
} else {
