...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__44274_SHARP_,p2__44273_SHARP_){
return p2__44273_SHARP_.toUpperCase();
}));
...
var G__44350 = o;
helix.impl.props.goog$module$goog$object.set(G__44350,k,v);
...
while(true){
if(cljs.core.seq(m)){
var G__44570 = cljs.core.rest(m);
var G__44571 = (function (){var entry = cljs.core.first(m);
...
return helix.impl.props.into_js_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44555_SHARP_){
if(cljs.core.map_QMARK_(p1__44555_SHARP_)){
return helix.impl.props.primitive_obj.cljs$core$IFn$_invoke$arity$1(p1__44555_SHARP_);
} else {
...
while(true){
if(cljs.core.seq(m)){
var G__44573 = cljs.core.rest(m);
var G__44574 = (function (){var entry = cljs.core.first(m);
...
while(true){
if(cljs.core.seq(m)){
var G__44577 = cljs.core.rest(m);
var G__44578 = (function (){var entry = cljs.core.first(m);
var k = cljs.core.key(entry);
var v = cljs.core.val(entry);
