...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_44770 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_44770(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_44771 = (function (reader){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_44771(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_44772 = (function (reader,ch){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_44772(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_44773 = (function (reader){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_44773(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_44774 = (function (reader){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_44774(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_44775 = (function (reader){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_44775(reader);
}
});
...
var G__44797 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__44798 = s.append(c);
c = G__44797;
s = G__44798;
continue;
}
