    ...
    function warnUnhydratedInstance(returnFiber, instance) {
      switch(returnFiber.tag) {
        ...
        case 5:
          ...
          if (0 !== (returnFiber.mode & 1) || !0 !== returnFiber.memoizedProps.suppressHydrationWarning) {
    ...
    function updateDehydratedSuspenseComponent(current, workInProgress, didSuspend, nextProps, suspenseInstance, suspenseState, renderLanes) {
      ...
      if (didReceiveUpdate || digest) {
        ...
        if (null !== nextProps) {
          ...
          suspenseInstance = 0 !== (suspenseInstance & (nextProps.suspendedLanes | renderLanes)) ? 0 : suspenseInstance;
          0 !== suspenseInstance && suspenseInstance !== suspenseState.retryLane && (suspenseState.retryLane = suspenseInstance, markUpdateLaneFromFiberToRoot(current, suspenseInstance), scheduleUpdateOnFiber(nextProps, current, suspenseInstance, -1));
        }
